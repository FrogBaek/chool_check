...
'홈' 화면입니다. 사용자는 여기서 NaverMap을 통해 출근을 인증하거나 우측 상단의 버튼을 통해 '마이페이지' 화면으로 이동할 수 있습니다. 
  - 상세 설명 : 
    a. 우측 하단에 위치한 버튼을 통해 현재 위치로 돌아갈 수 있습니다.
    b. 화면에 보이는 녹색 원은 출근을 인증할 수 있는 범위를 나타냅니다.
    c. 아래에 위치한 '출근하기' 버튼을 통해 출석체크를 할 수 있습니다. 단 조건은 아래와 같습니다.
      * 사용자가 근무하는 회사이면서 인증 가능한 범위(녹색 원)에 위치해야 합니다.
    d. 성공적으로 출첵을 하게되면 출근 완료 메시지와 함께 출근한 시간을 볼 수 있습니다.
